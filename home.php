...
<title>App Chat - HOME</title>
    ...
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.7.0/js/bootstrap.min.js">
             ...
             <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                 ...
                 <div class="row">
                     <div class="col-md-12 right-chat-textbox">
                         <form method="post">
                             <input autocomplete="off" type="text" name="msg_content" placeholder="Escribe tu mensaje...">
                             <button class="btn" name="submit"><i class="fa fa-telegram" aria-hidden="true">Enviar</i></button>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            if($msg == ""){
                echo"
                    <div class='alert alert-danger'>
                       <strong><center>El mensaje no pudo ser enviado.</center></strong>
                    </div>
           ...
           ";
                ...
                echo"
                    <div class='alert alert-danger'>
                       <strong><center>El mensaje es demasiado largo! Solo se permiten 100 caracteres.</center></strong>
                    </div>
